...
export function TamagotchiWidget({ isOpen }: TamagotchiWidgetProps) {
  ...
  <ChatBubble message={lastMessage.content} className="transition-all duration-500 ease-in-out h-auto" />
) : (
  <ChatBubble message={lastMessage.content} className="transition-all duration-500 ease-in-out h-0" />
)}
